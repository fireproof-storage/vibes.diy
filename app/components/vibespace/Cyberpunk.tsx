  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {isLoading ? (
          ...
          <div
            ...
            style={{ color: NEONS[bgIndex], textShadow: `0 0 12px ${NEONS[bgIndex]}` }}
          >
            NO VIBES FOUND
            <br />
      ...
      <div
        ...
        style={{ borderColor: NEONS[(bgIndex + 1) % NEONS.length], opacity: 0.8 }}
      />
      <div
        className="absolute bottom-0 left-0 h-10 w-10 border-b-4 border-l-4"
        style={{ borderColor: NEONS[(bgIndex + 2) % NEONS.length], opacity: 0.8 }}
      />
      <div
        className="absolute right-0 bottom-0 h-10 w-10 border-r-4 border-b-4"
        style={{ borderColor: NEONS[(bgIndex + 3) % NEONS.length], opacity: 0.8 }}
      />
    </div>
  );
}
