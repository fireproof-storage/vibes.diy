...
const BRAIN_LEVELS: BrainLevel[] = [
  ...
  { name: 'Enhanced Brain', color: 'indigo-500', glow: '0 0 25px rgba(99, 102, 241, 0.8)' },
  { name: 'Expanding Brain', color: 'purple-600', glow: '0 0 35px rgba(147, 51, 234, 0.9)' },
  { name: 'Cosmic Brain', color: 'pink-500', glow: '0 0 45px rgba(236, 72, 153, 1)' },
];
                ...
                >
                  ...
                  <div className="relative z-10 mb-2 flex items-center justify-between">
                    <h3
                      ...
                      style={{
                        textShadow:
                          vibeLevel > 1 ? `0 0 5px ${BRAIN_LEVELS[vibeLevel].glow}` : 'none',
                      }}
                    >
                      {doc.title || doc._id}
                    </h3>
                  ...
                  <div className="mt-3 flex space-x-3">
                    ...
                    {doc.slug && (
                      <a
                        ...
                        style={{
                          boxShadow:
                            vibeLevel > 1 ? `0 0 10px ${BRAIN_LEVELS[vibeLevel].glow}` : 'none',
                        }}
                      >
